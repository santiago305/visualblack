      ...
      <div className="container-vb relative">
        <div className="mx-auto max-w-3xl">
          <SectionHeading
            ...
            description="Ofrecemos soluciones integrales que cubren todo el espectro digital con enfoque estrategico, diseño claro y ejecución orientada a resultados."
          />
        </div>
