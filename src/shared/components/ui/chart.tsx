...
import { THEMES, type ChartConfig } from "@/shared/components/ui/chart.types";
import { getPayloadConfigFromPayload } from "@/shared/components/ui/chart.utils";
...
function ChartTooltip(props: TooltipProps<TooltipValueType, ChartNameType>) {
          ...
          {payload.map((item, index) => {
            ...
            const payloadValue =
              typeof item.payload === "object" && item.payload !== null
                ...
                : undefined;
            const fill = typeof payloadValue?.fill === "string" ? payloadValue.fill : undefined;
